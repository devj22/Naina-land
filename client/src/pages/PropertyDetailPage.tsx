...
const PropertyDetailPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formRef.current || !property) return;
    setLoading(true);
    
    // Use EmailJS with direct access to form
    emailjs.sendForm(
      'service_vukrrkb',  // Your EmailJS service ID
      'template_56ixdpl', // Your EmailJS template ID
      formRef.current,
      'IK3vSBYEhSRQfQ6Ti' // Your EmailJS public key
    )
      .then((result) => {
        setLoading(false);
                ...
                {property && (
                  <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 mb-8 border-2 border-primary" ref={detailsRef}>
                    ...
                    <div className="relative" style={{ paddingBottom: "56.25%" /* 16:9 Aspect Ratio */ }}>
                      <iframe 
                        src="https://www.youtube.com/embed/ycRY-EtA_y0"
